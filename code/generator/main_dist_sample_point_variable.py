...
from models.TacGen_once_predict_variable import TacGen, LossCriterion
from models.train_dist_sample_point_variable import train_dist
...
parser.add_argument('--use_variational', type=str, default='true', choices=['true', 'false'])
parser.add_argument('--data_path', type=str, default='/home/trl/fllm/ma_reflection/givego_curated_0730_dist_thresh_2_with_player.jsonl', help='path to the dataset')
...
def main():
    ...
    loss_criterion = LossCriterion(kl_weight=0.0001)
